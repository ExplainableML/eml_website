    ...
    return (
        ...
        <div id="publications" className="container flex flex-col items-center mb-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3  gap-8 w-full p-6">
                {props.publications.sort(function(a,b) {return new Date(b.date)- new Date(a.date)}).map(publication => <PublicationCard key={publication.filename || publication.title} publication={publication}>
