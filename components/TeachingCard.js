...
export default function TeachingCard(props) {
    ...
    return (<a href={"/teaching/"+link}><div className=" overflow-hidden shadow-lg bg-white p-16 flex flex-col items-center justify-center">
       ...
       <a className="text-purple-500 font-semibold" href="/teaching/lectures">View Details</a>
</div> 
...
<a className="text-purple-500 font-semibold" href="/teaching/seminars">View Details</a>
</div>
...
<a className="text-purple-500 font-semibold" href="/teaching/thesis">View Details</a>
</div>
           </div>}
