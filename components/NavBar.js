    ...
    <nav class="flex w-full items-center justify-between flex-wrap bg-gray-50 p-6">
      ...
      <div class="w-full md:hidden flex-grow lg:flex lg:items-center lg:w-auto " id="navbar">
        <div class="text-sm lg:flex-grow lg:text-right">
          <a href="#responsive-header" class="block mt-4 font-semibold lg:inline-block lg:mt-0 text-teal-100 hover:text-purple-500 mr-4 text-lg">
            Team
          </a>
          <a href="#responsive-header" class="block mt-4 font-semibold lg:inline-block lg:mt-0 text-teal-100 hover:text-purple-500 mr-4 text-lg">
            Publications
          ...
          <a href="#responsive-header" class="block mt-4 font-semibold lg:inline-block lg:mt-0 text-purple-100 hover:text-purple-500 mr-4 text-lg">
            Contact
          </a>
        </div>
      </div>
