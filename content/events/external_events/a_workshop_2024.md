...
There is no registration fee, however the venue has limited capacity. If you are interested in attending, we recommend registering ASAP. Registration is available [here](https://forms.gle/YrUzVXRmZqS2Gvb89).
<br/>
    ...
    <tbody>
        <tr>
            <td>
 			...
 			<td>
                <a href=https://www.eml-munich.de/> <div class="flex flex-col items-center justify-center"> <Image class="rounded-full mb-4" width="185" height="185" objectFit="cover"  src=/workshop_2024/placeholder.png alt=TBD ></Image> <a href=https://www.eml-munich.de/ class="mt-3 text-purple-500 text-lg md:text-base font-bold" > TBD </a> <p class="mt-3 text-purple-500 text-base md:text-xs font-bold">Akata Lab</p> </div></a>
            </td>
 			<td>
