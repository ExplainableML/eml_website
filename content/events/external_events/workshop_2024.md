...
---
<div class="w-full h-full bg-cover bg-center" style="height: 500px; background-repeat: no-repeat; background-position: center; background-image: url(/workshop_2024/HPC_front_opaque.png); ">
        <div class="flex justify-center h-full w-full" style="height:100%; vertical-align: top;">
            <div class="text-center" >
                <h1 class="black" style="vertical-align: middle;">Connecting Minds and Machines:  </h1>
                <h1 class="black" style="vertical-align: middle;">a Foundation Model Approach to Learning  </h1>
                <p style="text-align: center; color: black"><b> July 8th, 2024  |  Helmholtz Pioneer Campus, Munich, Germany </b></p>
            </div>
        </div>
    </div>
...
<div class="mb-8 flex flex-col items-center">
<img src=/workshop_2024/map.png width="100%"/>  
</div>

<div class="mb-8 flex flex-col items-center">
<img src=/workshop_2024/HPC_side.png width="40%"/>  
</div>
    ...
    <tbody>
        <tr>
            <td>
 			...
 			<td>
                <a href=https://www.eml-munich.de/> <div class="flex flex-col items-center justify-center"> <Image class="rounded-full mb-4" width="300" height="300" objectFit="cover"  src=/workshop/placeholder.png alt=TBD ></Image> <a href=https://www.eml-munich.de/ class="mt-3 text-purple-500 text-lg md:text-base font-bold" > TBD </a> <p class="mt-3 text-purple-500 text-base md:text-xs font-bold">TBD</p> </div></a>
            </td>
 			<td>
                <a href=https://www.eml-munich.de/> <div class="flex flex-col items-center justify-center"> <Image class="rounded-full mb-4" width="300" height="300" objectFit="cover"  src=/workshop/placeholder.png alt=TBD ></Image> <a href=https://www.eml-munich.de/ class="mt-3 text-purple-500 text-lg md:text-base font-bold" > TBD </a> <p class="mt-3 text-purple-500 text-base md:text-xs font-bold">TBD</p> </div></a>
            </td>
...
<table cellpadding="14">
    ...
    <tbody>
        <tr>
            <td>
                <a href=https://fortuin.github.io/> <div class="flex flex-col items-center justify-center"> <Image class="rounded-full mb-4" width="185" height="185" objectFit="cover" src=/workshop_2024/vincent.jpeg alt=Vincent Fortuin ></Image> <a href=https://fortuin.github.io/ class="mt-3 text-purple-500 text-lg md:text-base font-bold" > Vincent Fortuin </a> <p class="mt-3 text-purple-500 text-base md:text-xs font-bold">Helmholtz Munich</p> </div></a>
            </td>
 			<td>
                <a href=https://www.eml-munich.de/> <div class="flex flex-col items-center justify-center"> <Image class="rounded-full mb-4" width="250" height="250" objectFit="cover"  src=/workshop/placeholder.png alt=TBD ></Image> <a href=https://www.eml-munich.de/ class="mt-3 text-purple-500 text-lg md:text-base font-bold" > TBD </a> <p class="mt-3 text-purple-500 text-base md:text-xs font-bold">Akata Lab</p> </div></a>
            </td>
 			<td>
                <a href=https://www.eml-munich.de/> <div class="flex flex-col items-center justify-center"> <Image class="rounded-full mb-4" width="250" height="250" objectFit="cover"  src=/workshop/placeholder.png alt=TBD ></Image> <a href=https://www.eml-munich.de/ class="mt-3 text-purple-500 text-lg md:text-base font-bold" > TBD </a> <p class="mt-3 text-purple-500 text-base md:text-xs font-bold">Schulz Lab</p> </div></a>
            </td>
        </tr>
        <tr>
            <td>
                <a href=https://www.eml-munich.de/> <div class="flex flex-col items-center justify-center"> <Image class="rounded-full mb-4" width="250" height="250" objectFit="cover" src=/workshop/placeholder.png alt=TBD ></Image> <a href=https://www.eml-munich.de/ class="mt-3 text-purple-500 text-lg md:text-base font-bold" > TBD </a> <p class="mt-3 text-purple-500 text-base md:text-xs font-bold">Bauer Lab</p> </div></a>
            </td>
 			<td>
                <a href=https://www.eml-munich.de/> <div class="flex flex-col items-center justify-center"> <Image class="rounded-full mb-4" width="250" height="250" objectFit="cover"  src=/workshop/placeholder.png alt=TBD ></Image> <a href=https://www.eml-munich.de/ class="mt-3 text-purple-500 text-lg md:text-base font-bold" > TBD </a> <p class="mt-3 text-purple-500 text-base md:text-xs font-bold">TBD</p> </div></a>
            </td>
