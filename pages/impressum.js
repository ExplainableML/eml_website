...
export default function Impressum(props) {
    ...
    <div>
      <p><span style="text-decoration: underline;">Angaben gem. § 5 TMG:</span></p><p>&nbsp;</p>
      <p>Zeynep Akata</p><p>AI Research Building, Maria-Von-Linden-Straße 6</p><p>72076 Tübingen</p><p>&nbsp;</p>
      <p><span style="text-decoration: underline;">Kontaktaufnahme:</span></p><p>&nbsp;</p>
      <p>Telefon: +49 7071 2970824</p><p>E-Mail: eml-sekretariat (at) inf.uni-tuebingen.de</p><p>&nbsp;</p>
      <p><strong>Haftungsausschluss - Disclaimer:</strong></p><p>&nbsp;</p><p><span style="text-decoration: underline;">Haftung für Inhalte</span></p><p><strong>&nbsp;</strong></p>
      ...
      <p>Eine diesbezügliche Haftung ist jedoch erst ab dem Zeitpunkt der Kenntniserlangung einer konkreten Rechtsverletzung möglich. Bei Bekanntwerden von den o.g. Rechtsverletzungen werden wir diese Inhalte unverzüglich entfernen.</p><p>&nbsp;</p>
      <p><span style="text-decoration: underline;">Haftungsbeschränkung für externe Links</span></p><p><strong>&nbsp;</strong></p>
      ...
      <p>Diese Haftungsausschlusserklärung gilt auch innerhalb des eigenen Internetauftrittes „<em>www.eml-unitue.de</em>“ gesetzten Links und Verweise von Fragestellern, Blogeinträgern, Gästen des Diskussionsforums. Für illegale, fehlerhafte oder unvollständige Inhalte und insbesondere für Schäden, die aus der Nutzung oder Nichtnutzung solcherart dargestellten Informationen entstehen, haftet allein der Diensteanbieter der Seite, auf welche verwiesen wurde, nicht derjenige, der über Links auf die jeweilige Veröffentlichung lediglich verweist.</p>
      <p>Werden uns Rechtsverletzungen bekannt, werden die externen Links durch uns unverzüglich entfernt.</p><p>&nbsp;</p>
      <p><span style="text-decoration: underline;">Urheberrecht</span></p><p><strong>&nbsp;</strong></p>
