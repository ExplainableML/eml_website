  ...
  const renderers = {
    ...
    return (
      ...
      <br></br>
		...
		rehypePlugins={[rehypeKatex, rehypeRaw]} skipHtml={false} children={props.data.abstract} />
              </div>
...
<ReactMarkdown   remarkPlugins={[remarkMath, gfm]}
rehypePlugins={[rehypeKatex, rehypeRaw]} skipHtml={false} children={props.content} />
</div>
